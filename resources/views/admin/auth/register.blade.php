...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ url('/') }}/cpanel/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  ...
  <div class="register-box-body">
    ...
    <form class="form-group" method="POST" action="{{ url('admin/register') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
...
<!-- iCheck -->
<script src="{{ url('/') }}/cpanel/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
